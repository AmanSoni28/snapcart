              ...
              {cartData.map((item, index) => (
                ...
                >
                  ...
                  <div className="flex items-center justify-center sm:justify-end gap-3 mt-3 sm:mt-0">
                    <button className="bg-white p-2 rounded-full hover:bg-green-100 transition border border-gray-200">
                      <Minus
                        size={14}
                    ...
                    <button className="bg-white p-1.5 rounded-full hover:bg-green-100 transition border border-gray-200">
                      <Plus
                        size={14}
                        className="text-green-700"
