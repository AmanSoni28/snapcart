...
function TrackOrder() {
  ...
  const sendMsg = () => {
    ...
    socket.emit("send-message", message); //send the message to socket
    setNewMessage("");
  };
  ...
  return (
    <div className="w-full min-h-screen bg-linear-to-b from-green-50 to-white">
      <div className="max-w-2xl mx-auto p-24">
        <div className="sticky top-0 bg-white/80 backdrop-blur-xl p-4 border-b shadow flex gap-3 items-center z-[9999]">
          <button
