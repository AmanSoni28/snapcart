    ...
    <div className="flex flex-col items-center justify-center min-h-screen px-6 py-10 bg-white relative">
      ...
      onClick={()=>signIn("google", {callbackUrl: "/"})}>
        ...
        <p className="text-gray-600 mt-4 text-sm flex items-center justify-center gap-1">
          Already have an account ? <LogIn className="w-4 h-4 cursor-pointer" onClick={()=>router.push('login')}/> <span className="text-green-600 cursor-pointer" onClick={()=>router.push('login')} >Sign in</span>
        </p>
