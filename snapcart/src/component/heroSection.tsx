...
function HeroSection() {
    ...
    const slides = [
    {
      ...
      btnText: "Shop Now",
      bg:"https://images.unsplash.com/photo-1516594798947-e65505dbb29d?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
    },
...

    {
      ...
      btnText:"Get Started",
      bg:"https://media.istockphoto.com/id/1454687282/photo/vegetable-at-a-farmers-market.webp?a=1&b=1&s=612x612&w=0&k=20&c=RyLjMKgfA3DAj-dgN1EAIISj5nR-C3hVs4PYAAp0MoQ="
    },
    ];
    ...
    const timer=setInterval(()=>{
        setCurrenr((prev)=>(prev+1)%(slides.length) )
    },4000)
    return ()=>clearInterval(timer)
    },[])

  return (
    <div className='relative w-[98%] mx-auto mt-32 h-[75vh] rounded-3xl overflow-hidden shadow-2xl'>
      ...
      <div className="absolute inset-0 flex items-center justify-center text-center text-white px-6">
        ...
        >
          ...
          <motion.button
            ...
            className="mt-4 bg-white text-green-700 hover:bg-green-100 px-8 py-3 rounded-full shadow-lg transition-all duration-300 flex items-center gap-2"
          >
